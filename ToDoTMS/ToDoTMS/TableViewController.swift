...
class TableViewController: UITableViewController {
    ...
    @IBAction func peshAddAction(_ sender: Any) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let currentIteam = ToDoItems[indexPath.row]
        cell.textLabel?.text = currentIteam["Name"] as? String
        
      if  (currentIteam["isCompleted"] as? Bool) == true {
